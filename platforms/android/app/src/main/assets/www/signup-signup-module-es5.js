...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(authService, toastService, storageService, router, fb) {
    ...
    SignupComponent.prototype.validateInputs = function () {
        var firstname = this.postData.firstname.trim();
        var lastname = this.postData.lastname.trim();
        var localisation = this.postData.localisation.trim();
        var mail = this.postData.mail.trim();
        var gender = this.postData.gender.trim();
    ...
    SignupComponent.prototype.signAction = function () {
        var _this = this;
    ...
    SignupComponent.prototype.fbsignlogin = function () {
        this.fb
            .login(["public_profile", "user_friends", "email"])
            .then(function (res) {
            return console.log("Logged into Facebook!", res);
        })
