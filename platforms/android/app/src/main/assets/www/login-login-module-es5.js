...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, authService, storageService, toastService) {
        this.router = router;
    ...
    LoginComponent.prototype.validateInputs = function () {
        ...
        if (this.validateInputs()) {
            this.authService.login(this.postData).subscribe(function (res) {
                if (res.userData) {
                    ...
                    _this.storageService.store(_config_auth_constants__WEBPACK_IMPORTED_MODULE_4__["AuthConstants"].AUTH, res.userData);
                    _this.storageService.store("isLoggedin", "true");
                    _this.router.navigate([""]);
                }
                else {
                    _this.toastService.presentToast("incorrect password.");
